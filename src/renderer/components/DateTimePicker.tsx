  ...
  return (
    <div className="dtp-wrapper" ref={ref}>
      <button
        ...
        title={value ? `${t('reminder')}: ${new Date(value).toLocaleString('pl-PL')}` : t('setReminder')}
      ...
      {value && (
        <span className="reminder-badge">
          ...
          <button className="reminder-clear" onClick={onClear} aria-label={t('removeReminder')}>&times;</button>
        </span>
      )}
